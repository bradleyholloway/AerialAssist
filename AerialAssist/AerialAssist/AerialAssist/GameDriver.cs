...
namespace AerialAssist
{
    ...
    public class GameDriver : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            robots.Add(new AerialRobot(sonic, new Vector2(sonicScale * widthScale, .12f * heightScale), new Vector2(widthScale * 260f, heightScale * 100f), Color.Blue, (float)Math.PI+.00001f, 0f, new KeyboardInput(PlayerIndex.Two), AerialRobot.UnicornDrive, !keyboard2, AerialRobot.RecieveAndShootAI, AerialRobot.WhitePrimary));
